...
public class NewsCrawler extends BreadthCrawler {
    ...
    public NewsCrawler(String crawlPath, boolean autoParse) {
        ...
        /*种子页面*/
        this.addSeed("http://www.xbiquge.la");

        /*正则规则设置*/
        /*爬取符合 http://news.hfut.edu.cn/show-xxxxxxhtml的URL*/
        this.addRegex("http://www.xbiquge.la/.*");
        /*不要爬取 jpg|png|gif*/
    ...
    public void visit(Page page, CrawlDatums next) {
        ...
        if (page.matchUrl("http://www.xbiquge.la/.*/")) {
            ...
            String title = page.select("div[id=info]>h1").first().text();
            String content = page.select("div#intro", 0).text();
...
/*        if (page.matchUrl("http://www.xbiquge.la/.*html")) {
            we use jsoup to parse page
            Document doc = page.doc();
